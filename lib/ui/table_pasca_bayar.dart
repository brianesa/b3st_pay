...
class TablePascaBayar extends StatefulWidget {
  final ResultsDataSource _resultsDataSource = ResultsDataSource([]);
  final bool isLoaded = false;

  @override
  _TablePascaBayarState createState() => _TablePascaBayarState();
}

class _TablePascaBayarState extends State<TablePascaBayar> {
        ...
        body: Container(
          ...
          child:
            ...
            PaginatedDataTable(
                ...
                columnSpacing: 20.0,
                header: const Text('Data Transaksi Pasca bayar'),
